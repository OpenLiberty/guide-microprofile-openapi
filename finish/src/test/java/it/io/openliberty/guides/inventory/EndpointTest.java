...
public class EndpointTest {
    ...
    public static void oneTimeSetup() {
        port = System.getProperty("lib.http.test.port");
    ...
    public void testUnknownHost() {
        ...
        Response badResponse = client.target(baseUrl + INVENTORY_SYSTEMS + "/badhostname").request(MediaType.APPLICATION_JSON).get();
