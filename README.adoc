...
To use pregenerated OpenAPI documents first create the complete OpenAPI document.
...
This document is the same as your current OpenAPI document with additional APIs for the `/inventory/properties` endpoint. 
