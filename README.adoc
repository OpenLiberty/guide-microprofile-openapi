...
Your OpenAPI document also doesn't have a description of `SystemData`, similarly to `InventoryList`
add some OpenAPI annotations to `src/main/java/io/openliberty/guides/inventory/model/SystemData.java`:
