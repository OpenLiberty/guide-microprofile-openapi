...
Add OpenAPI [hotspot=APIResponses file=0]`@APIResponses`, [hotspot=Operation file=0]`@Operation`, 
[hotspot=APIResponseSchema file=0]`@APIResponseSchema`, and [hotspot=Parameter file=0]`@Parameter` annotations to the two JAX-RS methods, 
