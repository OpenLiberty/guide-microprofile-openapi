...
The [hotspot=27-46]`filterOpenAPI()` method allows filtering of the singleton [hotspot=27]`OpenAPI` element. Unlike other filter
methods, when you override [hotspot=27-46]`filterOpenAPI()`, it is called only once as the last method
