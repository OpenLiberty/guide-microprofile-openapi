...
[role='code_command hotspot=32-46 file=0', subs="quotes"]
----
Add OpenApi annotations to `getPropertiesForHost()`.
`src/main/java/io/openliberty/guides/inventory/InventoryResource.java`
----

[role='code_command hotspot=70-81 file=0', subs="quotes"]
----
Add OpenApi annotations to `listContents()`.
`src/main/java/io/openliberty/guides/inventory/InventoryResource.java`
----
...
[role='code_command hotspot=7 file=1', subs="quotes"]
----
Add the OpenApi annotation to the `InventoryList` class.
`src/main/java/io/openliberty/guides/inventory/model/InventoryList.java`
----

[role='code_command hotspot=10 file=1', subs="quotes"]
----
Add the OpenApi annotation to the `systems` variable.
`src/main/java/io/openliberty/guides/inventory/model/InventoryList.java`
----
...
[role='code_command hotspot=6 file=2', subs="quotes"]
----
Add the OpenApi annotation to the `SystemData` class.
`src/main/java/io/openliberty/guides/inventory/model/SystemData.java`
----

[role='code_command hotspot=9 file=2', subs="quotes"]
----
Add the OpenApi annotation to the `hostname` variable.
`src/main/java/io/openliberty/guides/inventory/model/SystemData.java`
----

[role='code_command hotspot=12 file=2', subs="quotes"]
----
Add the OpenApi annotation to the `properties` variable.
`src/main/java/io/openliberty/guides/inventory/model/SystemData.java`
----
...
Again, run the following command and refresh the {openapi-url} URL to see the updated OpenAPI tree.
[role='command']
```
mvn compile
```
...
[role="code_command hotspot=1-48", subs="quotes"]
----
Create the `OASFilter` interface.
...
by passing in the fully qualified name of the filter class into the [hotspot=1]`mp.openapi.filter` property.

Finally, run the following command and refresh the {openapi-url} URL to see the updated OpenAPI tree.
[role='command']
```
mvn compile
```
...
Run the following command and refresh the {openapi-url} URL to see the updated OpenAPI tree.
[role='command']
```
mvn compile
```
...
tests separately from the build by using the following command, but first make sure that the server is stopped.
```
mvn verify
```
