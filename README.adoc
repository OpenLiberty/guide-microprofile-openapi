...
Explore how to document and filterRESTful APIs from code or static files by using MicroProfile OpenAPI.
...
You will document the RESTful APIs of the provided `inventory` service. If you have read through
...
To learn more about MicroProfile Config, visit the MicroProfile GitHub https://github.com/eclipse/microprofile-config[repository]
and try one of the MicroProfile Config guides.
...
If the document is partially complete, then you can augment it with further code or filters.
...
For more in-depth examples of MicroProfile OpenAPI, try one of the demo applications on the
