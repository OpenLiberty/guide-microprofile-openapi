...
for documenting and exposing RESTful APIs. This specification gives both humans and computers a better understanding
...
and try one of the https://openliberty.io/guides/?search=Config[MicroProfile Config guides].
