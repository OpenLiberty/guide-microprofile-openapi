...
Now, point to the {openapi-url} URL to see the generated OpenAPI tree. As before, you can also point to 
the {openapi-url}/ui URL for a more interactive view of the APIs.
