...
[role='edit_command_text']
Add OpenAPI annotations [hotspot=SystemData hotspot=Hostname hotspot=Properties file=2]`@Schema` to the [hotspot=SystemData file=2]`SystemData` class, the [hotspot=Hostname file=2]`hostname` variable and the [hotspot=Properties file=2]`properties` variable.
