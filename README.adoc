...
Add OpenAPI annotations to the two JAX-RS methods, [hotspot=32-46 file=0]`getPropertiesForHost()` and [hotspot=70-81 file=0]`listContents()`.
...
[role="edit_command_text"]
Set the [hotspot=1]`mp.openapi.scan.disable` property to `true`.
